  ...
  render() {
    return (
      <div className="column">
        ...
        <div className="ui divider hidden"></div>
        <Link to="/blog" className="ui secondary basic button">
          Go Back
        </Link>
        <div className="ui red basic button" onClick={this.props.delete}>
          Delete
        </div>
      </div>
    );
...
class Article extends Component {
  ...
  componentWillMount() {
    ...
    if (this.props.match.params.id) {
      this.props.dispatch(actions.blog.getArticle({
        ...
        <section className="ui basic segment">
          <div className="ui container">
            <div className="ui centered grid">
              ...
              <div className="one wide column mobile only row">
                <ArticleContent delete={this.delete} title={title} content={content} updated={updated}/>
              </div>
            </div>
          </div>
